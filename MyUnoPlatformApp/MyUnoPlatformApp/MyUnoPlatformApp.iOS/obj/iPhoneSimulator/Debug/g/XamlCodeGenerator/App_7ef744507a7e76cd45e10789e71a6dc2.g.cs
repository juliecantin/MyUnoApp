...
namespace MyUnoPlatformApp
{
	...
	partial class App : Windows.UI.Xaml.Application
	{
				private void InitializeComponent()
		{
			...
			.GenericApply((c0 => 
			{
				// Source C:\p\MyUno\MyUnoPlatformApp\MyUnoPlatformApp\MyUnoPlatformApp.Shared\App.xaml (Line 1:2)
			...
			global::MyUnoPlatformApp.GlobalStaticResources.Initialize();
			global::MyUnoPlatformApp.GlobalStaticResources.RegisterResourceDictionariesBySourceLocal();
			global::Uno.UI.DataBinding.BindableMetadata.Provider = new global::MyUnoPlatformApp.BindableMetadataProvider();
			#if __ANDROID__
			global::Uno.Helpers.DrawableHelper.Drawables = typeof(global::MyUnoPlatformApp.Resource.Drawable);
			#endif
			// MergedDictionaries
			...
			// Source ..\..\..\..\..\..\..\MyUnoPlatformApp.Shared\App.xaml (Line 1:2)
		}
...
namespace MyUnoPlatformApp
{
	static class App_7ef744507a7e76cd45e10789e71a6dc2XamlApplyExtensions
	{
	}
}
